...
public class TextSeekBar extends BaseSeekBar {
    ...
    private static final int DEFAULT_THUMB_IMAGE_NORMAL = R.mipmap.icon_map_list_term_icon;
    private static final int DEFAULT_THUMB_IMAGE_PRESSED = R.mipmap.icon_map_list_term_icon;
