...
public class SlidingSeekBar extends BaseSeekBar {
    ...
    private static final int DEFAULT_THUMB_IMAGE_NORMAL = R.mipmap.icon_map_term_timer_bar;
    private static final int DEFAULT_THUMB_IMAGE_PRESSED = R.mipmap.icon_map_term_timer_bar;
