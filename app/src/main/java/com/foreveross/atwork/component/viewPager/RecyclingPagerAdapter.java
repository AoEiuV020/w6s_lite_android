...
public abstract class RecyclingPagerAdapter extends PagerAdapter {
  ...
  private final HashMap<Integer, View> viewData = new HashMap<>() ;
  ...
  @Override public void notifyDataSetChanged() {
    ...
    for(Map.Entry<Integer, View> entry : viewData.entrySet()) {
      refreshView(entry.getKey(), entry.getValue());
    }
  ...
  public abstract void refreshView(int position, View view);
}
