...
public class LeftReferencedAnnoImageMessageChatItemView extends LeftBasicReferenceUserChatItemView implements IAnnoImageChatView {
    ...
    public LeftReferencedAnnoImageMessageChatItemView(Context context) {
        super(context);
        findView();
    ...
    private void findView() {
        ...
        View view = inflater.inflate(R.layout.chat_left_referenced_anno_image_message, this);
