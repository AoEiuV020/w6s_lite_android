...
public class RightReferencedImageMessageChatItemView extends RightBasicReferenceUserChatItemView implements IImageChatView {
    ...
    public RightReferencedImageMessageChatItemView(Context context) {
        super(context);
        findView();
        registerListener();
    ...
    private void findView() {
        ...
        View view = inflater.inflate(R.layout.chat_right_referenced_image_message, this);
