...
public class ItemLargeDetailViewPager extends ViewGroup {
	...
	private EnlargedImageAdapter mAdapter;
	private int mCurItem; // Index of currently displayed page.
	private int mRestoredCurItem = -1;
	private Parcelable mRestoredAdapterState = null;
	private ClassLoader mRestoredClassLoader = null;
	private Scroller mScroller;
	private EnlargedImageAdapter.DataSetObserver mObserver;
	...
	public interface OnPageChangeListener {
		 ...
		 */
		void onPageSelected(int position, int prePosition);
	...
	public ItemLargeDetailViewPager(Context context, AttributeSet attrs) {
		super(context, attrs);
		initViewPager();
	}
	...
	public void setAdapter(EnlargedImageAdapter adapter) {
		if (mAdapter != null) {
	...
	public EnlargedImageAdapter getAdapter() {
		return mAdapter;
	}
	...
	private class DataSetObserver implements EnlargedImageAdapter.DataSetObserver {
		@Override
