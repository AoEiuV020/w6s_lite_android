...
import kotlinx.android.synthetic.main.component_workbench_item_app_container_0.view.*

class WorkbenchAppContainer0ItemView : RelativeLayout {
    ...
    private fun findViews() {
        LayoutInflater.from(context).inflate(R.layout.component_workbench_item_app_container_0, this)
    ...
    fun refreshView(itemDataWrapper: WorkbenchAppContainerItemDataWrapper, workbenchCard: WorkbenchCard?) {
        if (null == itemDataWrapper.appBundle) {
            ...
            tvAppName.text = StringUtils.EMPTY
            tvAppName.isVisible = false
...
//        unreadImageView.setIcon(R.mipmap.icon_item_workbench_card_app_add)

        tvAppName.text = appBundle.getTitleI18n(BaseApplicationLike.baseContext)
