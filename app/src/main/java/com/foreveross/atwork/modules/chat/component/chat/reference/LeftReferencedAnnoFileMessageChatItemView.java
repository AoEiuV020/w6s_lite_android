...
public class LeftReferencedAnnoFileMessageChatItemView extends LeftBasicReferenceUserChatItemView implements IAnnoFileChatView {
    ...
    public LeftReferencedAnnoFileMessageChatItemView(Context context) {
        super(context);
        findView();
        registerListener();
    ...
    private void findView() {
        ...
        View view = inflater.inflate(R.layout.chat_left_referenced_anno_file_message, this);
