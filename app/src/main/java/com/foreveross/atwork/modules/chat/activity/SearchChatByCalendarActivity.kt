 ...
 */
class SearchChatByCalendarActivity : SingleFragmentActivity() {
    ...
    companion object {
        fun startActivity(context: Context, sessionId: String) {
            ...
            val intent = Intent(context, SearchChatByCalendarActivity::class.java)
    ...
    override fun createFragment(): Fragment {
        val fragment = SearchChatByCalendarFragment()
