...
public class RightReferencedGifMessageChatItemView extends RightBasicReferenceUserChatItemView implements IGifChatView {
    ...
    public RightReferencedGifMessageChatItemView(Context context) {
        super(context);
        findView();
        registerListener();

        mChatViewRefreshUIPresenter = new GifChatViewRefreshUIPresenter(this);
    ...
    private void findView() {
        ...
        View view = inflater.inflate(R.layout.chat_right_referenced_gif_message, this);
        ...
        mGivContent = view.findViewById(R.id.giv_content);
