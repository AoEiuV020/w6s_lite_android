...
public class RightReferencedFileMessageChatItemView extends RightBasicReferenceUserChatItemView implements IFileChatView {
    ...
    public RightReferencedFileMessageChatItemView(Context context) {
        super(context);
        findView();
        registerListener();

        mChatViewRefreshUIPresenter = new FileChatViewRefreshUIPresenter(this);
        ((FileChatViewRefreshUIPresenter) mChatViewRefreshUIPresenter).setNormalFileNameColor("#ffffff");
        ((FileChatViewRefreshUIPresenter) mChatViewRefreshUIPresenter).setExpiredFileNameColor("#80ffffff");
    ...
    private void findView() {
        ...
        View view = inflater.inflate(R.layout.chat_right_referenced_file_message, this);
