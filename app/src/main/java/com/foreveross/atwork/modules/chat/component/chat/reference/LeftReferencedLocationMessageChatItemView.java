...
public class LeftReferencedLocationMessageChatItemView extends LeftBasicReferenceUserChatItemView implements ILocationChatView {
    ...
    public LeftReferencedLocationMessageChatItemView(Context context) {
        super(context);
        findView();
        registerListener();
    ...
    private void findView() {
        ...
        View view = inflater.inflate(R.layout.chat_left_referenced_location_message, this);
