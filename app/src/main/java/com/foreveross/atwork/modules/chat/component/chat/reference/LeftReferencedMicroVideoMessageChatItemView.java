...
public class LeftReferencedMicroVideoMessageChatItemView extends LeftBasicReferenceUserChatItemView implements IMicroVideoChatView {
    ...
    public LeftReferencedMicroVideoMessageChatItemView(Context context) {
        super(context);
        findView();
        registerListener();
    ...
    private void findView() {
        ...
        View view = inflater.inflate(R.layout.chat_left_referenced_micro_video_message, this);
