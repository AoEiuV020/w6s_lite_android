 ...
 */
public class MyDownloadFileItem extends RelativeLayout {
    ...
    public MyDownloadFileItem(Context context) {
        super(context);
        mContext = context;
        initViews(context);
    }
    ...
    public void setGroupTime() {
            mFileGroupTime.setVisibility(GONE);
    }
    ...
    public void setFileItemListener(FileData fileData) {
        mExpandIcon.setOnClickListener(view2 -> {
            if (mOnIconSelectedListener != null) {
                mOnIconSelectedListener.onExpandIconClick(fileData);
            }
        });
    }
    ...
    public interface OnItemIconClickListener{
        void onExpandIconClick(FileData fileData);
    }
}
