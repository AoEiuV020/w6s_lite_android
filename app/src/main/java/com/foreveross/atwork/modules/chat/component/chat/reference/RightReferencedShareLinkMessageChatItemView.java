...
public class RightReferencedShareLinkMessageChatItemView extends RightBasicReferenceUserChatItemView implements IShareLinkChatView {
    ...
    public RightReferencedShareLinkMessageChatItemView(Context context) {
        super(context);
        findView();
        registerListener();
    ...
    private void findView() {
        ...
        View view = inflater.inflate(R.layout.chat_right_referenced_share_link_message, this);
