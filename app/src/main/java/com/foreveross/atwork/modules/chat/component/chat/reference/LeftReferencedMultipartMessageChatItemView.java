...
public class LeftReferencedMultipartMessageChatItemView extends LeftBasicReferenceUserChatItemView implements IMultipartChatView {
    ...
    public LeftReferencedMultipartMessageChatItemView(Context context) {
        super(context);
        findView();
        registerListener();
    ...
    private void findView() {
        ...
        View view = inflater.inflate(R.layout.chat_left_referenced_multipart_message, this);
