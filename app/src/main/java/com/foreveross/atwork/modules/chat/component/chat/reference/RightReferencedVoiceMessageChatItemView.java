...
public class RightReferencedVoiceMessageChatItemView extends RightBasicReferenceUserChatItemView implements PlayAudioListener, IVoiceChatView {
    ...
    public RightReferencedVoiceMessageChatItemView(Context context) {
        super(context);
        findView();
        registerListener();

        mVoiceChatViewRefreshUIPresenter = new VoiceChatViewRefreshUIPresenter(context, this);
        mVoiceChatViewRefreshUIPresenter.setVoiceAnimationPlaying(R.drawable.reference_message_voice_animation_white);
        mVoiceChatViewRefreshUIPresenter.setVoiceImgStill(R.mipmap.reference_voice_play_animation2_white);
    ...
    private void findView() {
        ...
        View view = inflater.inflate(R.layout.chat_right_referenced_voice_message, this);
