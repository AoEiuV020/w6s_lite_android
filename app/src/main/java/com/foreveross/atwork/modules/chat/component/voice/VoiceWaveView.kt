...
class VoiceWaveView @JvmOverloads constructor(
    ...
    init {
        attrs?.let {
            ...
            lineWidth = typedArray.getDimension(R.styleable.VoiceWaveView_waveLineWidth, 20f)
            lineSpace = typedArray.getDimension(R.styleable.VoiceWaveView_waveLineSpace, 10f)
            ...
            lineColor = typedArray.getInt(R.styleable.VoiceWaveView_waveLineColor, Color.BLUE)
            ...
            val lType = typedArray.getInt(R.styleable.VoiceWaveView_waveLineType, 0)
            when (lType) {
    ...
    fun updateBodyList(numList: LinkedList<Int>) {
        bodyWaveList.clear()
        numList

                .let {
                    bodyWaveList.addAll(it)
                }
    }
