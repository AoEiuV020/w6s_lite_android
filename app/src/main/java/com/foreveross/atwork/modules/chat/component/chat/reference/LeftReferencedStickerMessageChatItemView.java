...
public class LeftReferencedStickerMessageChatItemView extends LeftBasicReferenceUserChatItemView implements IStickerChatView {
    ...
    public LeftReferencedStickerMessageChatItemView(Context context) {
        super(context);
        findView();
        registerListener();
    ...
    private void findView() {
        ...
        View view = inflater.inflate(R.layout.chat_left_referenced_sticker_message, this);
