...
import static com.foreveross.atwork.modules.login.activity.LoginSignAgreementActivity.INTENT_FACE_LOGIN_TICKET;

public class FaceLoginAgreementFragment extends BaseAgreementFragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        ticket = getArguments().getString(INTENT_FACE_LOGIN_TICKET);
    ...
    void onNextBtnClicked() {
        UserLoginAgreementAsyncService.signFaceLoginAgreement(getActivity(), ticket, new BaseCallBackNetWorkListener() {
            @Override
    ...
    @Override
    String getLoadUrl() {
        return UserLoginAgreementSyncService.getFaceLoginAgreementUrl(getActivity());
    }
}
