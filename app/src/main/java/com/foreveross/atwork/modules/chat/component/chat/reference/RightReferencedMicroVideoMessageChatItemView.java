...
public class RightReferencedMicroVideoMessageChatItemView extends RightBasicReferenceUserChatItemView implements IMicroVideoChatView {
    ...
    public RightReferencedMicroVideoMessageChatItemView(Context context) {
        super(context);
        findView();
        registerListener();

        mChatViewRefreshUIPresenter = new MicroVideoChatViewRefreshUIPresenter(context, this);
    ...
    protected void registerListener() {
        ...
        mCoverView.setOnClickListener(v -> ImageSwitchInChatActivity.showImageSwitchView(getContext(), mReferencedChatMessage.mReferencingMessage, null));
    ...
    private void findView() {
        ...
        View view = inflater.inflate(R.layout.chat_right_referenced_micro_video_message, this);
        ...
        mCoverView = view.findViewById(R.id.iv_video_cover);
