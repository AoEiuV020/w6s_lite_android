...
public class RightReferencedTextMessageChatItemView extends RightBasicReferenceUserChatItemView implements ITextChatView {
    ...
    public RightReferencedTextMessageChatItemView(Context context) {
        super(context);
        findView();
        registerListener();
    ...
    private void findView() {
        ...
        View view = inflater.inflate(R.layout.chat_right_referenced_text_message, this);
