...
public class LeftReferencedGifMessageChatItemView extends LeftBasicReferenceUserChatItemView implements IGifChatView {
    ...
    public LeftReferencedGifMessageChatItemView(Context context) {
        super(context);
        findView();
        registerListener();
    ...
    private void findView() {
        ...
        View view = inflater.inflate(R.layout.chat_left_referenced_gif_message, this);
