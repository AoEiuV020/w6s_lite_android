...
public class RightReferencedLocationMessageChatItemView extends RightBasicReferenceUserChatItemView implements ILocationChatView {
    ...
    public RightReferencedLocationMessageChatItemView(Context context) {
        super(context);
        findView();
        registerListener();

        mChatViewRefreshUIPresenter = new LocationChatViewRefreshUIPresenter(this);
    }
    ...
    private void findView() {
        ...
        View view = inflater.inflate(R.layout.chat_right_referenced_location_message, this);
