...
public class ShakeDetector implements SensorEventListener {
    ...
    public static final int SENSITIVITY_HARD = 13;
     ...
     */
    private int accelerationThreshold = SENSITIVITY_HARD;
...
//        LogUtil.i("shadow",magnitudeSquared+"");
