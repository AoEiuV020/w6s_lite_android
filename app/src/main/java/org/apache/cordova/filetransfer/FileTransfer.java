...
public class FileTransfer extends CordovaPlugin implements WorkplusFileTransferHandler {

    private static final String LOG_TAG = "FileTransfer";
    private static final String LINE_START = "--";
    private static final String LINE_END = "\r\n";
    private static final String BOUNDARY =  "+++++org.apache.cordova.formBoundary";
...
//                    boolean multipartFormUpload = (headers == null) || !headers.has("Content-Type");
                    boolean multipartFormUpload = true;
     ...
     */
    protected void download(final String source, final String target, JSONArray args, CallbackContext callbackContext) throws JSONException {
