...
import com.foreveross.atwork.qrcode.zxing.config.Config;
...
public final class DecodeThread extends Thread {
	...
	public DecodeThread(ZxingQrcodeInterface zxingQrcodeInterface,
		...
		if (decodeFormats == null || decodeFormats.isEmpty()) {
			SharedPreferences prefs = PreferenceManager
					.getDefaultSharedPreferences(zxingQrcodeInterface.getQrActivity());
	...
	public void run() {
		Looper.prepare();
		handler = new DecodeHandler(zxingQrcodeInterface, hints);
