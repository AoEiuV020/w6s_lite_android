 ...
 */
@Deprecated
public class DataSchemasDBHelperV1 implements DBHelper {

    private static final String TAG = DataSchemasDBHelperV1.class.getSimpleName();
    ...
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
        ...
        if (oldVersion < 140) {
            W6sDatabaseHelper.addColumnToTable(db, TABLE_NAME, DBColumn.VISIBLE_RANGE, "text");
            oldVersion = 140;
        }
    }
