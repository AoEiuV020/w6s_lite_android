 ...
 * 全局的开关设置数据库表
 */
public class ConfigSettingDBHelper implements DBHelper {

    public static final String TABLE_NAME = "settings_v2_";

    /**
     * create table settings_ (source_id_ text, type_ integer, business_case_ text, value_ integer, language_ text, primary key (source_id_, business_case_))
     */
    public static final String SQL_EXEC = CREATE_TABLE + TABLE_NAME + LEFT_BRACKET  +
                                            ...
                                            DBColumn.SOURCE_ID + COMMA +
//                                            DBColumn.SOURCE_TYPE + COMMA +
                                            DBColumn.BUSINESS_CASE + RIGHT_BRACKET + RIGHT_BRACKET;
