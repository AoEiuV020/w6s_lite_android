...
public class PatternUtils {
    ...
    public final static int WEB_URL = 0;
    public final static int EMAIL = 1;
    public final static int PHONE = 2;
    public final static int AT = 4;
    public final static int WORKPLUS_SCHEMA_URL = 5;
    public final static int TEXT_LINK = 6;
    public static String atPatternReg = "@[^\\s]{2,}";

    /**
     * 电话号码匹配规则, 用于修改提交时做校验区别于{@link #phonePatternRegCommon}, 它支持3位短号
     * */
    public static String phonePatternRegEdit = "^\\d?(\\d-?){2,18}\\d$";

    public static String phonePatternRegCommon = "((?<=\\D)|^)(0\\d{9,13}|\\d{2,5}-\\d{7,10}|\\d{3}-\\d{4}-\\d{4}|1+[3578]+\\d{9}|\\d{7,10})((?=\\D)|$)";
    public static String mobilePatternReg = "^(0|86|17951)?(13[0-9]|15[012356789]|18[0-9]|14[57]|17[678])[0-9]{8}$";
...
//    private static String webUrlPatternReg = "(((file|gopher|news|nntp|telnet|http|ftp|https|ftps|sftp)://)|(www\\.))?(([a-zA-Z0-9\\._-]+\\.[a-zA-Z]{2,6})(:[0-9]{1,5})?|([0-9]{1,3}\\.[0-9]{1,3}\\.[0-9]{1,3}\\.[0-9]{1,3})(:[0-9]{1,5})?)(/[a-zA-Z0-9\\&%_\\./-~-]*)?";
    public static String webUrlPatternReg = "((((file|gopher|news|nntp|telnet|(h|H)ttp|ftp|(h|H)ttps|ftps|sftp)://)|(www\\.))?(([a-zA-Z0-9\\.,_-]+(?!\\.((?i)(jpg|png|jpeg|bmp|gif|mp3|mp4|rmvb|avi|mov|amr|doc|docx|xls|xlsx|ppt|pptx|txt|pdf|ipa|apk)))(\\.[a-zA-Z]{2,6}))(:[0-9]{1,5})?|([0-9]{1,3}\\.[0-9]{1,3}\\.[0-9]{1,3}\\.[0-9]{1,3})(:[0-9]{1,5})?))(/?[a-zA-Z0-9\\#&%_\\.,/-~-+()!]*)?\\s*";
    public static String workplusSchemaUrlPatternReg = "(((workplus|Workplus|rfchina|Rfchina)://))(([a-zA-Z0-9\\.,_-]+)(:[0-9]{1,5})?)(/?[a-zA-Z0-9\\#&%_\\.,/-~-+()!]*)?\\s*";
    public static String emailPatternReg = "[A-Z0-9a-z\\._%+-]+@([A-Za-z0-9-]+\\.)+[A-Za-z]{2,4}";
    public static String emojiPatternReg = "[\ud83c\udc00-\ud83c\udfff]|[\ud83d\udc00-\ud83d\udfff]|[\u2600-\u27ff]";
