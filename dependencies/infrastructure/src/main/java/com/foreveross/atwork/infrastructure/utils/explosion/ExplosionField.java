...
public class ExplosionField extends View {
    ...
    public void explode(final View view) {
        ...
        int startDelay = 300;
        final int amplitude = DensityUtil.dip2px(4);
        ...
        animator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            ...
            public void onAnimationUpdate(ValueAnimator animation) {
                view.setTranslationX((random.nextFloat() - 0.5f) * amplitude);
                view.setTranslationY((random.nextFloat() - 0.5f) * amplitude);
    ...
    private void explodeMaxArea(Rect r) {
        int screenWidth = ScreenUtils.getScreenWidth(getContext());
        int screenHeight = ScreenUtils.getScreenHeight(getContext());
        if((screenWidth / 4) > r.left) {
            r.left = (screenWidth / 4);
            r.top = (screenHeight - screenWidth / 2) / 2;
            r.right = screenWidth / 4 * 3;
            r.bottom = r.top + screenWidth / 2;
        }
    }
