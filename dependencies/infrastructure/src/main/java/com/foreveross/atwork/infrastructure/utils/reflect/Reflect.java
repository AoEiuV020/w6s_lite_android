 ...
 */
package com.foreveross.atwork.infrastructure.utils.reflect;
...
public class Reflect {
    ...
    public Reflect call(String name, Object... args) throws ReflectException {
        ...
        return callInFixedType(name, types, args);


    }

    @NonNull
    public Reflect callInFixedType(String name, Class<?>[] types, Object[] args) {
