...
/**
 *  create by reyzhang22 at 2019-09-24
 */
class RoundProgressBar @JvmOverloads constructor(context: Context, attrs: AttributeSet? = null, defStyle: Int = 0) : View(context, attrs, defStyle) {
    ...
    override fun onDraw(canvas: Canvas) {
        ...
        paint.setColor(cricleColor) //设置圆环的颜色
        ...
        //设置进度是实心还是空心
        paint.setStrokeWidth(roundWidth) //设置圆环的宽度
        paint.setColor(cricleProgressColor)  //设置进度的颜色
        val oval = RectF((centre - radius + 15 ).toFloat(), (centre - radius + 15).toFloat(), (centre + radius-15 ).toFloat(), (centre + radius-15 ).toFloat())  //用于定义的圆弧的形状和大小的界限
