...
public class SQLiteDatabase implements SQLiteDatabaseStrategy {
    ...
    public static final int CONFLICT_IGNORE = net.sqlcipher.database.SQLiteDatabase.CONFLICT_IGNORE;

    public static final int CONFLICT_REPLACE = net.sqlcipher.database.SQLiteDatabase.CONFLICT_REPLACE;

    public net.sqlcipher.database.SQLiteDatabase mSQLiteDatabase;
    ...
    public static SQLiteDatabase openOrCreateDatabase(Context context, String name, String password, net.sqlcipher.database.SQLiteDatabase.CursorFactory factory) {
        return new SQLiteDatabase(net.sqlcipher.database.SQLiteDatabase.openOrCreateDatabase(context.getDatabasePath(name), password, factory));
    }

    public static SQLiteDatabase openOrCreateDatabase(File file, String password, net.sqlcipher.database.SQLiteDatabase.CursorFactory factory) {
        return new SQLiteDatabase(net.sqlcipher.database.SQLiteDatabase.openOrCreateDatabase(file, password, factory));
    }
